...
class KMeansPlot:
    def __init__(self, X, cluster_list):
        self.X = X
    ...
    def plot(self):
        color_type = [
            ...
            'gnuplot_r', 'gray', 'gray_r', 'grey', 'hot', 'hot_r', 'hsv', 'hsv_r', 'inferno', 'inferno_r', 'jet', 'jet_r', 
        ...
        plt.scatter(self.X[:,0], self.X[:,1], c=self.cluster_list, s=40, cmap=plt.cm.get_cmap(random.choice(color_type)))
        plt.show()
